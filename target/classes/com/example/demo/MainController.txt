...
public class MainController {
    ...
    @GetMapping(path="/")
	public @ResponseBody String home() { return "FEANA - Ernesto Anaya Ruiz";}

    @GetMapping(path="codigo")
    public @ResponseBody String codigo() { return "FEANA";}

    @GetMapping(path="nombre-completo")
    public @ResponseBody String nombre() { return "FEANA - Ernesto Anaya Ruiz";}

	@PostMapping(path="/api/curso/nuevo") 
	public @ResponseBody String nuevo (@RequestParam String nombre, @RequestParam String creditos) {
		Curso n = new Curso();
		n.setNombre(nombre);
